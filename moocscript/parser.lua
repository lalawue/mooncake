...
vCmSMT = pBlanks * Cmt(pCmLong + pCmShort, fMarkStype("cm")) * pBlanks, vStrExpr = pBlanks * Ct(Cg(fName("sexp"), "etype") * P('"') * (pStrRaw * P("\\(") * pBlanks * Ct(vExpr) * pBlanks * P(")") * pStrRaw) ^ 1 * P('"')), --
